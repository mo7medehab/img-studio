        ...
        <div className="py-[2%] px-[10%]">
            <div className="hero bg-linear-to-br from-base-300 via-base-100 to-base-200 mx-auto  py-[15%] px-[20%] rounded-xl">
                <div className="hero-content text-center">
                    ...
                    <h1 className="text-5xl font-bold">Edit <span className="text-5xl font-bold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">Images </span>in browser</h1>
                    <p className="py-6">
